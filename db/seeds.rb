...
80.times {Book.create!(title:Faker::Book.unique.title, cover:"/app/assets/images/coming-soon.jpg", description:Faker::Lorem.paragraph_by_chars(number: 256, supplemental: false), author_id:rand(1..20))}

20.times {
  user = User.create!(username:Faker::Internet.unique.username, email:Faker::Internet.unique.email, img_url:"/app/assets/images/coming-soon.jpg", password:"asd123", password_confirmation:"asd123")
